...
cursor.execute("create TABLE tags (id INT(11) NOT NULL primary key auto_increment,tag_name CHAR(10) NOT NULL)")
print "[*] Create table 'articles_tags' ..."
cursor.execute("create TABLE articles_tags (id INT(11) NOT NULL primary key auto_increment,article_id INT(11) NOT NULL,\
